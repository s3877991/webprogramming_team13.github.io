...
<body>
    ...
    <header>
        <nav>
            ...
            <ul class="menu">
                ...
                <li><a class="active" href="store-contact-us.php">CONTACT</a></li>
    ...
    <main>
        ...
        <!--Contact form-->
        <form method="get" action="store-home.php">
            <div class="container">
                ...
                <div class="flex-container">
                    ...
                    <div class="item flex">
                        ...
                        <br>
                        <input type="tel" name="phone" minlength=9 maxlength=13 placeholder="Enter your phone number"
                            required>
                    </div>
